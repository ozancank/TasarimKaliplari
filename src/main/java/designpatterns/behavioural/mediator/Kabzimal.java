...
public class Kabzimal implements Araci {
    private final List<Uretici> ureticiList;
    private final List<Halci> halciList;
    ...
    private void satisYap(Uretici uretici, Halci halci) {
        System.out.println(uretici.getAdi() + " isimli üretici " + halci.getAdi() + " isimli halciye " +
                uretici.getUrun().getUrun() + " sattı.");
    }
}
